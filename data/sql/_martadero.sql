...
(`code`, `shape`, `coords`, `label`, `description1`, `capacity`)
VALUES
('A1',   'rect', '94,113,132,259', 'Playa Grande', 'Mega espacio central: Artes Escénicas. Música, Interacción Social, Música, Audiovisual, Artes Visuales y Fotografía.', '200 personas sentadas / 400 personas de pie.'),
('A2',   'rect', '136,133,166,239', 'Sala de chanchos', 'Exposiciones de artes visuales, presentaciones de  libros, talleres.', '140 personas sentadas / 280 personas de pie.'),
('A3',   'rect', '60,188,91,239', 'Trozadero', 'Sala de proyección.', '56 personas sentadas / 100 personas de pie.'),
('A4',   'rect', '60,133,91,185', 'Playa chica', 'Sala de ensayo, teatro de cámara y talleres.', '56 personas sentadas / 100 personas de pie.'),
('B1',   'rect', '51,10,74,70', 'Sala de los cueros', 'Taller infantil de libre expresión.', '40 personas sentadas / 80 personas de pie.'),
('B2',   'rect', '154,10,178,70', 'Sala de la carne robada', 'Sala de exposición / filmaciones / ensayos.', '40 personas sentadas / 80 personas de pie.'),
('B3',   'rect', '79,10,89,34', 'Lavadero de cueros', 'Cocineta para taller.', ''),
('B4',   'rect', '94,10,111,34', 'Ovejaducto', 'Baños Educativos.', ''),
('B5',   'rect', '125,10,149,34', 'Baños', 'Baños.', ''),
('C1',   'rect', '6,75,28,170', 'Sala de corderos', 'Sala de exposiciones.', '80 personas sentadas / 200 personas de pie.'),
('C2',   'rect', '6,175,28,202', 'Sala de corderos 2', 'Espacio reservado para laboratorio de fotografía.', '10 personas sentadas / 30 personas de pie.'),
('C3',   'rect', '6,208,28,241', 'Pi Producciones :: Santo de los mañazos', 'Pi Producciones : Productora Independiente.', ''),
('C4',   'rect', '6,247,28,297', 'Escenario al Aire Libre (Sala de suyus)', 'Espacio reservado para eventos al aire libre.', ''),
('C6',   'rect', '33,331,54,349', 'Veterinaria', 'Oficina de gestión mARTadero y FI.', '20 personas.'),
('C7',   'rect', '61,331,82,349', 'Administración', 'Secretaria de información.', '20 personas.'),
('D1',   'rect', '202,74,221,118', 'Sala Hub - Sala Visceral 1', 'Sala de videoconferencias y talleres.', '30 personas sentadas / 70 personas de pie.'),
('D2',   'rect', '202,124,221,170', 'Sala formARTe - Sala Visceral 2', 'Sala de talleres.', '30 personas sentadas / 70 personas de pie.'),
('D3',   'rect', '202,175,221,207', 'Sala Visceral 3', 'Espacio ocupado provisionalmente por el Gobierno Municipal de Cochabamba como deposito.', ''),
('D4',   'rect', '202,212,221,244', 'Sala Visceral 4', 'Espacio destinado a sala de exposiciones.', '25 personas sentadas / 50 personas de pie'),
('D5',   'rect', '200,251,221,298', 'Café Itaca - Colgadero de cueros', 'Café Cultural ITACA.', '40 personas dentro / 120 fuera.'),
('D6',   'rect', '202,304,221,319', 'Dirección', 'Dirección.', ''),
('D7',   'rect', '143,330,195,349', 'Cantina', 'Espacio destinado a Fundación Imagen (gestión y producción cultural).', '20 personas'),
('D6pb', 'rect', '202,342,221,353', 'LabDigital - Sala de patas', 'Espacio destinado a laboratorio de arte digital.', '10 personas.'),
('D6pa', 'rect', '202,322,221,336', 'Residencia de Artistas NORTE - Burdel', 'Residencia de artistas NORTE.', '6 personas'),
('C6pa', 'rect', '6,304,26,322', 'Residencia de Artistas SUR', 'Residencias de artistas.', '8 personas'),
('E1',   'rect', '7,12,46,70', 'Sala de las cabezas', 'Expresión corporal contemporánea.', '80 personas sentadas / 130 personas de pie.'),
('E2',   'rect', '183,8,224,68', 'Zona del chancho pelado', 'Vivienda familiar - Portería - y depósito.', ''),
('F1',   'circle', '112,296,20', 'Patio de carga', 'Uso múltiple y terraza Itaca.', '300'),
('F2',   'circle', '113,76,21', 'Jardín Ecológico', 'Educación Medioambiental para niñ@s.', '');
