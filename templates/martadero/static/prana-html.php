...
<ul class="index">
    ...
    <li><a href="#pascana">Pascana</a></li>
    <li><a href="#catapulta">Catapulta</a></li>
    <li><a href="#redes">Redes</a></li>
    <li><a href="#espacio">Espacio</a></li>
    <li><a href="#aporte">Aporte</a></li>
...
<strong>espacios equipados y con constantes eventos multidisciplinarios</strong>
que posibilita estar rodeado de la <strong>creación local</strong>.</p>

<p>En ese sentido, <strong>la Residencia artística prAna es más que un
refugio</strong> con ciertas facilidades para artistas y gestores culturales; es
parte de <strong>una dinámica colectiva</strong> que se nutre <strong>de
experiencias y aproximaciones</strong> que propician <strong>convivencias
creativas</strong> fundamentales en una <strong>búsqueda
...
innovador y de mayor crecimiento de Bolivia</strong>.</p>

<p>Para desarrollar aún más los principios citados y conectar a Bolivia con el
panorama internacional, el proyecto mARTadero -ayudado por la
<a href="http://www.fundacionimagen.org" target="_blank">Fundación Imagen</a> y
la  Embajada de Holanda- ha construido en el sitio y desarrollado un modelo de
gestión para unas residencias orientadas a artistas y gestores culturales,
llamadas <strong>PRANA (Programa de Residencias Artísticas de
NADA)</strong>.</p>

<p><strong>PRANA</strong> es además una palabra en sánscrito se refiere a "lo
vital", a la <strong>fuerza de las cosas vivas y la energía generadora en el
proceso natural del universo</strong>. Viene de los Upanishads, y sugiere esa
parte de la realidad física que es el soporte del cuerpo y la madre de la mente
y el pensamiento.</p>
...
<p>Esta modalidad esta abierta a todos aquellos artistas, gestores culturales e
investigadores de cualquier disciplina y nacionalidad con deseo de plantear una
propuesta clara y creativa, un trabajo realizable en el tiempo de residencia,
ya sea asumido como trabajo en proceso o con objetivos muy concretos. Pero sobre
todo proyectos conscientes de la experiencia de vivir y trabajar en Villa
...
<h3>Autogestionado por el residente</h3>
<p>El Residente llega por sus propios medios y paga un costo bastante razonable
por la Residencia y todos sus beneficios.</p>
<p>Para informarte sobre el <a href="#aporte">aporte por uso de estadía en las
residencias pincha aquí</a></p>
<p>Estos aportes por uso están realizados según una escala de países por el IDH
(Índice de Desarrollo Humano) que
<a href="https://docs.google.com/spreadsheet/ccc?key=0AtuhBpIn0Kx8dFN3WHNQbEh4UHgzbHlEQ0ZydGYyRVE" target="_blank">puedes consultar aquí</a>.</p>

<p>Para participar en la Residencia en la modalidad de autogestionada envíanos
...
<ul>
    <li>La <strong>experiencia e interés del artista</strong>: su hoja de vida,
    líneas de investigación, obras anteriores, etc. La experiencia artística de
    los candidatos, será valorada así como su desempeño en procesos
    interdisciplinarios y sociales.</li>
    <li>El <strong>proyecto a desarrollar</strong>: pertinencia, rigor
    conceptual y formal, posibilidad de realizarlo en el tiempo solicitado,
    enfoque interdisciplinar, etc.</li>
</ul>

<h3>Programas</h3>
<p>Convenios o apoyos provenientes de instituciones vinculadas a Arte,
Universidades, etc.</p>

<h3>Redes</h3>
<p>Intercambios a través de Redes. Generalmente esta modalidad de residencia se
realiza con convocatorias muy definidas que son publicadas en el transcurso de
...
<h4>PAQUETE ESTÁNDAR de COMUN&amp;CA para TODXS los ARTISTAS RESIDENTES en
PROGRAMA PRANA:</h4>
<ul>
    <li>Las residencias se publican en la web de 2 a 3 semanas antes de la
    llegada del artista.</li>
    <li>Se le hará agenda de medios en prensa, radio y tv.</li>
    <li>Nota de prensa a propósito de su llegada realizando una breve entrevista
    para el armado de la nota.</li>
    <li>Difusión en redes sociales.</li>
</ul>
<h4>PAQUETE ESPECIAL COMUN&amp;CA (sumado a lo arriba mencionado)</h4>
<p>Consultar para <strong>presupuesto</strong> a
...
<p>La capacidad está establecida en <strong>8 plazas</strong> (4 en cada cuarto)
en<strong> PRANA-Norte</strong>, y <strong>4 plazas</strong> en
<strong>PRANA-Sud</strong>, haciendo un total de <strong>12</strong>.</p>

<p>Un uso mayor de ello habrá de ser autorizado por Dirección del mARTadero para
...
artistas podrá ser programada en el calendario. Se ruega tomar en cuenta los
horarios de llegada y salida de prAna Pascana, los horarios de salida y llegada
deberán ser indicados en el formulario y ser cumplidos.</p>

<p><strong>Descuentos</strong>: En caso de niños menores a 12 años que
acompañan a sus padres, dos niños pagan por una persona y un único niño, no paga
la residencia.</p>

<h2><a name="catapulta"></a>prAna Catapulta</h2>
<p>Propicia que artistas bolivianos puedan ser parte de <strong>programas de
residencias en el exterior</strong> o encuentros de artistas que serán llamados
por convocatoria pública en la página web del mARTadero y medios de
comunicación.</p>
...
<h3>2012</h3>
<p><a href="http://worldeventyoungartists.com/" target="_blank">WEYA</a> - World Enconter of Young Artist<br />
Juan Fabbri.<br />
Joseph Arispe.<br />
Arterias Urbanas - Oscar Soza.</p>
...
<h2><a name="redes"></a>prAna Redes</h2>
<p><strong>Fomentamos y potenciamos</strong> la <strong>conectividad de
Bolivia</strong> con el exterior y viceversa a través de la
<strong>participación en redes colaborativas de intercambio de
artistas</strong>. Creemos firmemente en el aprendizaje mutuo que ello
supone.</p>
<p>Nos estamos <strong>involucrando en redes nacionales e
internacionales</strong> (especialmente latinoamericanas), contribuyendo cuanto
podemos <strong>en su consolidación</strong> y proyección a futuro.</p>
...
<ul>
    <li>La capacidad está establecida en <strong>8 plazas</strong> (4 en cada
    cuarto) en <strong>PRANA-Norte</strong>, y <strong>6 plazas</strong> en
    <strong>PRANA-Sud</strong>, haciendo un total de <strong>14</strong>.<br />
    ...
    hospedado.</li>
    <li><strong>INFO sobre el mARTadero</strong><br />
    <strong>Año de fundación</strong>: 2005.<br />
    <strong>Espacio arquitectónico</strong>: Ex-matadero  municipal
    (2.900 m²).<br />
    <strong>Ubicación Urbana</strong>: Zona Villa Coronilla.<br />
...
<p>Consulta la
<a href="https://docs.google.com/spreadsheet/ccc?key=0AtuhBpIn0Kx8dFN3WHNQbEh4UHgzbHlEQ0ZydGYyRVE" target="_blank">Escala
de precios por países según IDH para las residencias prAna</a>.</p>

<p><strong>Descuentos</strong>: Los niños menores de 12 años, que acompañan a
sus padres, no pagan en la residencia. Si son dos niños, pagan por una
persona.</p>

<h2><a name="contacto"></a>MAYOR INFORMACIÓN</h2>
<p>Proyecto <strong>mARTadero</strong> - Programa de Residencias Artísticas Nada
